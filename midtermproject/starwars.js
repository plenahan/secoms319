fetch("data.json")
    ...
    function loadMovies(myMovies) {
        ...
        for (var i = 0; i<myMovies.starWars.movies.length; i++){
            ...
            let title = myMovies.starWars.movies[i].title;
            let year = myMovies.starWars.movies[i].releaseDate;
            let file = myMovies.starWars.movies[i].file;
    ...
    document.addEventListener("DOMContentLoaded", function (e) {
        function handleCardClick(event) {
            ...
            console.log(value);
            window.location.href = `./singleMovie.html?greeting=${value}&genre=starWars`;
        }
